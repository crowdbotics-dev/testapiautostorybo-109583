...
## Project Structure
    ...
    ├── testapiautostorybo_109583  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_109583`
...
2. Clone this repo and `cd testapiautostorybo_109583`
